...
<video src="/javascript/defer01.mov" muted autoplay="autoplay" loop="loop"></video>

通过录制工具，可以看到渲染花费的时间：

![defer](/javascript/defer01.jpg)
...
<video src="/javascript/defer02.mov" muted autoplay="autoplay" loop="loop"></video>
